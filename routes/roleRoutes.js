...
const { getAllRoles, createRole, updateRole, deleteRole, updatePermissions, getPermissionGroups } = require('../controllers/roleController');
const auth = require('../middleware/authMiddleware');
const authorize = require('../middleware/roleMiddleware');

router.get('/', auth, authorize(['Administrator', 'Program Manager']), getAllRoles);
router.get('/permissions', auth, authorize(['Administrator']), getPermissionGroups);
